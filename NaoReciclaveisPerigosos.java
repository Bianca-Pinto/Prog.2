...
public class NaoReciclaveisPerigosos extends Coleta {
    public double quantidadeTotal;
    public double dataColeta;
    public char destino;

    public NaoReciclaveisPerigosos(double quantidadeTotal, double dataColeta, char destino, String local, int data, String veiculoTipo, String veiculoPlaca, double veiculoCapacidade, double quantidadeColetada, double soma) {
